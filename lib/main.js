...
var fortuneColor = document.getElementsByTagName('h1'); //or use document.getElementsByClassName('colors') and add a CSS 'color' class to the h1's --- use this instead...change h1's to p
...
function functionWrapper() {
    ...
    var runColor = function runColor() {
        ...
        for (var i = 0; i < thisColorLength; i++) {
            console.log('hi');
